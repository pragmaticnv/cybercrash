  ...
  const flags = [
    {
      ...
      observed: `${account.uniqueReceivers} Unique Beneficiaries`,
    ...
    },
    {
      ...
      observed: `${account.transferVelocity.toFixed(3)} Velocity Index`,
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-[11px] text-slate-400 font-sans">
              Algorithmic evidence breakdown based strictly on verified transaction observations
            </div>
          </div>
        </div>
